...
export default function TerminalWindow({ title, children, testId }) {
  return (
    <div
      data-testid={testId}
      className="w-[92vw] sm:w-full max-w-4xl h-[82vh] md:h-[78vh] mx-auto flex flex-col bg-term-panel rounded-xl border border-slate-200 shadow-2xl shadow-slate-200/60 overflow-hidden"
    >
      <div className="flex items-center gap-2 px-4 py-3 bg-term-header border-b border-slate-200 shrink-0">
